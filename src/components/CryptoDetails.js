...
<Title className='coin-details-heading'>{cryptoDetails.name} value statistics</Title>
...
<Row className='coin-desc'>
  <Title level={3} className='couin-details-heading' >
...
<Col className='coin-links'>
  ...
  {cryptoDetails.links?.map((link)=>(
    <Row claasName='coin-link' key={link.name}>
